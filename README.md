...
<p>
    ...
    <img alt="Static Badge" src="https://img.shields.io/badge/coverage-100%25-green"> <!-- Use %25 to encode %, edit the number to change the percentage, set to green above 90% coverage -->
</p>
